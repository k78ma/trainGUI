        ...
        for epoch in range(epochs):
            ...
            for i, data in enumerate(self.trainloader, 0):
                ...
                if root.epoch_bar['value'] > 100:
                    root.epoch_bar_label['text'] = "Epoch Progress: 100.00%"
                else:
                    root.epoch_bar_label['text'] = "Epoch Progress: {:.2f}%".format(root.epoch_bar['value'])
            ...
            test_loss, outputs, label_list, FP, FN, PGI = self.test.get_accuracy_test(self.testloader, self.model, self.device, epoch)
...
###################################################################################### best model saving ##############################
            ...
            print("Minimum MSE Loss: {}".format(min_test_loss))
########################################################################################################################################
            ...
            root.pgi_plot.scatter(epoch, PGI, color = '#88c999')
